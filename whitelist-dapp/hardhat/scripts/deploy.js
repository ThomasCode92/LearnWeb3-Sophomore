...
async function main() {
  /*
    ...
    so whitelistContract is a factory for instances of our Whitelist contract.
  */

  // here we deploy the contract, 10 is the Maximum number of whitelisted addresses allowed
